 ...
 * @author: TeamworkGuy2
 */
var Log4JavaScript = (function (_super) {
    __extends(Log4JavaScript, _super);
    function Log4JavaScript(edition, version) {
        _super.call(this);
        this.Level = Level;
        this.logLog = LogLog;
    ...
    Log4JavaScript.setupDefaultLogger = function (defaultAppender) {
        var logger = log4javascript.getLogger(Logger.defaultLoggerName);
        logger.addAppender(defaultAppender);
        return logger;
    };
    return Log4JavaScript;
}(EventSupport));
var log4javascript = new Log4JavaScript("log4javascript", "1.4.13");
log4javascript.setEventTypes(["load", "error"]);
// Main load
var logOnLoad = log4javascript.setDocumentReady;
