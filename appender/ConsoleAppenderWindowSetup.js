...
function script() {
    ...
    var LogItem = (function () {
        function LogItem() {
            ...
            this.unwrappedContainer = null;
            this.group = null;
        }
        LogItem.prototype.appendToLog = function () {
            for (var i = 0, len = this.elementContainers.length; i < len; i++) {
                this.elementContainers[i].appendToLog();
            }
            this.group.update();
        };
        LogItem.prototype.doRemove = function (doUpdate, removeFromGroup) {
            if (this.rendered) {
                for (var i = 0, len = this.elementContainers.length; i < len; i++) {
        ...
        LogItem.prototype.remove = function (doUpdate, removeFromGroup) {
            this.doRemove(doUpdate, removeFromGroup);
        };
        LogItem.prototype.render = function () { };
        LogItem.prototype.accept = function (visitor) {
            visitor.visit(this);
        };
        LogItem.prototype.getUnwrappedDomContainer = function () {
            return this.group.unwrappedElementContainer.contentDiv;
        };
        LogItem.prototype.getWrappedDomContainer = function () {
    ...
    var LogItemContainerElement = (function () {
        ...
        LogItemContainerElement.prototype.appendToLog = function () {
        ...
        return LogItemContainerElement;
    }());
    /*----------------------------------------------------------------*/
    var SeparatorElementContainer = (function (_super) {
        ...
        return SeparatorElementContainer;
    ...
    window.onload = function () {
        ...
        $("command").onkeypress = function (evt) {
            evt = getEvent(evt);
            if (evt.keyCode == 38 && commandHistory.length > 0 && evt.preventDefault) {
                evt.preventDefault();
            }
        };
